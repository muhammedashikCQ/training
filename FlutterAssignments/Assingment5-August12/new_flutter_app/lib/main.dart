                ...
                children: [
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          color: const Color.fromARGB(255, 252, 221, 255)),
                      child: const Text("Name: Muhammed Ashik A",
                          style: TextStyle(
                  ...
                  Container(
                    ...
                    child: InkWell(
                      ...
                      child: const Text("Email Id : muhammedashik@gmail.com",
                          style: TextStyle(
                              fontStyle: FontStyle.italic,
                              fontWeight: FontWeight.bold)),
                    ),
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(10),
                          color: const Color.fromARGB(255, 252, 221, 255)),
                      child: const Text("Phone No: 9207801300",
                          style: TextStyle(
                              fontStyle: FontStyle.italic,
                              fontWeight: FontWeight.bold))),
                  const SizedBox(
